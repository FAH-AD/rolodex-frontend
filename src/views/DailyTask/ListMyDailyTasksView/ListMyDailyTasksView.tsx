...
// Components
import { ListMyDailyTasksResult } from "./ListMyDailyTasksResult";
import { PageWrapper } from "@components/PageWrapper";
import { Button, Group } from "@mantine/core";

export const ListMyDailyTasksView = () => {
    ...
    <PageWrapper
      ...
      actions={
        <Group>
          ...
          />
          {verifyRole("admin") && (
            <Button component={Link} to="/dashboard/daily-tasks/all">
              Team's Tasks
            </Button>
          )}
        </Group>
